...
def adjust_prediction(predictions):
    ...
    # print("final shape:", np.shape(return_batch))
    # print("orginal shape", np.shape(predictions))
    # print(return_batch)
    # print(predictions)
    return return_batch
            ...
            #     np.append(return_batch, adjusted_predictions)
            #     # print(return_batch)
            #     # quit()
            #     adjusted_predictions.empty()
            # #return_batch = np.asarray(return_batch)
            # # print(np.shape(return_batch))
            # print(return_batch)
            # quit()
            # # print(batch)
            # quit()
            # adjusted_predictions = []
            # adjust_batch_predictions = []
            # for batch in predictions:
            #     for predict in batch:
            #         if predict > 0.75:
            #             adjusted_predictions.append(1)
            ...
            #         else:
            #             adjusted_predictions.append(predict)
            #     adjust_batch_predictions.append(adjusted_predictions)
            #     adjusted_predictions.clear()
            # adjust_batch_predictions = np.asarray(adjust_batch_predictions)
            # print("original predictions: ", np.shape(predictions))
            # print("adjusted_predictions: ", np.shape(adjust_batch_predictions))
            # quit()
            # return adjust_batch_predictions
